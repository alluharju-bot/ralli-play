...
**17.9.2026 · Päivitä-painike uusille versioille.** Peli tunnistaa tulevat julkaisut ja tarjoaa tallissa **Päivitä / Myöhemmin** -ilmoituksen. Päivitys odottaa ajoa ja keskeneräistä ulkonäköluonnosta sekä säilyttää tallennukset. Myöhemmin valittu päivitys löytyy tallin sivuvalikosta. Jo avoinna oleva tätä edeltävä peliversio tarvitsee vielä yhden tavallisen sivupäivityksen, jotta ilmoitustoiminto tulee käyttöön. Lähdeversio: `b467627`.
